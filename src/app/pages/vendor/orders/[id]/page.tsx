          ...
          <div className="space-y-5">
                ...
                <div className="flex items-start justify-between rounded-2xl bg-slate-50 p-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Bundle · Contains 3 items</p>
                    </div>
                  </div>
                  ...
                  <div key={item.name} className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-400">{item.stock}</p>
                      </div>
                    </div>
                    <button className="text-xs font-medium text-slate-900 underline-offset-4 hover:underline">
                      View in inventory
            ...
            <div className="rounded-3xl bg-white p-5 shadow-sm">
              ...
              <p className="mb-2 text-xs text-slate-500">
                Add private notes about this order (visible only to you and your
                team).
              </p>
              <textarea
