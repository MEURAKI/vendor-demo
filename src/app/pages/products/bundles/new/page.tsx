...
export default function NewProductPage() {
  ...
  useEffect(() => {
    if (!isCustomSku && !customSku) {
      setBaseSku(generateBaseSku(name));
    }
  }, [name, isCustomSku, customSku]);
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                {isVariant && (
                  <ProductVariantSettings
                    ...
                    onGroupNameChange={(groupId: any, name: any) =>
                      setOptionGroups((prev) =>
                        prev.map((g) =>
                  ...
                  <div className="space-y-4 text-xs sm:space-y-5">
                    ...
                    <div>
                      ...
                      <ChipsInput
                        ...
                        placeholder="e.g. Yoga Mat Sprays"
                      />
                      {categoryError && (
                        <p className="mt-1 text-[11px] text-red-600">
                          {categoryError}
                    ...
                    <div>
                      ...
                      <ChipsInput
                        items={tags}
                        onChange={setTags}
                        placeholder="e.g. Organic, Aromatherapy"
                      />
                    </div>
                  </div>
                </section>
